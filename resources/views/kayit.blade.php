...
<body>
    ...
    <div class="container" style="width: 30rem;" >
        <form method="POST" action="/kisikayit">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="adi" type="text" class="form-control @error('name') is-invalid @enderror" name="adi" value="{{ old('adi') }}" required autocomplete="adi" autofocus>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="adres" class="col-md-4 col-form-label text-md-end">Adres</label>

                <div class="col-md-6">
                    <textarea id="adres" type="text" class="form-control @error('adres') is-invalid @enderror" name="adres" value="{{ old('adres') }}" required autocomplete="adres" autofocus></textarea>
                </div>
            </div>
